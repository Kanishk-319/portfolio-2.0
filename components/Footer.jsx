    ...
    return (
        <div className='flex flex-col  gap-6'>
          ...
          sm:text-[5rem] text-left'>GOT QUESTIONS OR IDEAS BREWING?</p>
                <motion.button initial={{ backgroundColor: 'black', color: 'white' }} whileHover={{ backgroundColor: 'white', color: 'black', border: '1px solid black' }} className='self-end sm:mr-[10vw]  text-[13px] sm:text-lg  py-2 px-4 sm:px-6 rounded-3xl bg-black text-white'>Drop me a line</motion.button>
            </motion.div>
